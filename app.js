...
function dataChecker (planLimit, day, usage){
    ...
    else if(usage < planLimit && aveDaily === 3.333){
...
Which is below the average daily usage recommended: 3.333 GB/day.\n
Continuing this usage, and you will end up with 
${planLimit - aveDaily * remDay - usage} GB remaining on your plan.\n
We recommend to use ${3.33 - aveDaily} GB/day more on average to better benefit from your plan.`)
    }
    
    else {
return console.log(`${day} day(s) used, ${remDay} day(s) remaining\n
Your average daily usage is ${aveDaily} GB/day.🛜
You are EXCEEDING the average daily usage recommended: 3.333 GB/day.\n
